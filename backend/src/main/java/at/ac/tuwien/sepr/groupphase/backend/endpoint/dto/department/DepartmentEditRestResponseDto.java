package at.ac.tuwien.sepr.groupphase.backend.endpoint.dto.department;
...
public class DepartmentEditRestResponseDto {
    ...
    public DepartmentEditRestResponseDto() {
    }

    public DepartmentEditRestResponseDto(String name, String supervisorEmail) {
        this.name = name;
