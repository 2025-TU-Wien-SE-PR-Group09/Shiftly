...
public record EmployeeListItemResponseDto(String email, String firstName, String lastName) {
    public static EmployeeListItemResponseDto from(EmployeeListItemDto dto) {
        return new EmployeeListItemResponseDto(dto.email(), dto.firstName(), dto.lastName());
    }
}
