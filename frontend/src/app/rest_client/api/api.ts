...
export * from './mailEndpoint.service';
import { MailEndpointService } from './mailEndpoint.service';
...
export const APIS = [AdminEndpointService, CustomHealthEndpointService, DepartmentService, LoginEndpointService, MailEndpointService, RegistrationEndpointService, SickLeaveCertificateEndpointService, UserEndpointService, VacationEndpointService];
